...
namespace BlindRumble
{
    ...
    public class Class1 : MelonMod
    {
        ...
        public override void OnLateUpdate()
        {
            ...
            if (modEnabled)
            {
                var controller = Managers.GetPlayerManager().localPlayer.Controller.gameObject;
                ...
                var playerManager1 = Managers.GetPlayerManager();
        ...
        private IEnumerator DisableVFX(string currentScene, bool enabled)
        {
            ...
            var poolsParent = Pools.Structures.GetPoolCube().transform.parent;
        ...
        private IEnumerator DelayCharacterTransformation(string currentScene, bool IsLocalPlayer = true)
        {
            if (currentScene != "Loader" && currentScene != "")
            {
                ...
                if (currentScene == "Gym")
                {
                    ...
                    Transform visualsTransform = Managers.GetPlayerManager().localPlayer.Controller.transform.GetChild(0);
                            ...
                            if (playerManager1 != null && playerManager1.AllPlayers != null)
                            {
                                for (int index = 0; index < playerManager1.AllPlayers.Count; index++)
                                {
                                    ...
                                    if (player != null && player.Controller != null && player.Controller.name == "Player Controller(Clone)")
                                    {
                                        ...
                                        GameObject dummyPlayer = GameObject.Instantiate(Managers.GetPlayerManager().playerControllerPrefab.gameObject);
                ...
                if (currentScene == "Gym")
                {
                    ...
                    GameObject armMesh = GameObjects.Gym.Logic.HeinhouserProducts.MoveLearning.Ghost.Visuals.HandLPoseGhost.GetGameObject();
                    GameObject regionEurope = GameObjects.Gym.Logic.HeinhouserProducts.RegionSelector.GetGameObject().transform.Find("Model/WorldMap/Regions_Effectmesh/Region_Europe.002").gameObject;
                    
                    GameObject glassPane = GameObjects.Gym.Logic.HeinhouserProducts.ShiftstoneCabinet.Glassplane.GetGameObject();
                ...
                else if (currentScene == "Park" && modEnabled)
                {
                    ...
                    GameObjects.Park.LightingAndEffects.GetGameObject().SetActive(false);
                    GameObjects.Park.Scene.Mountains.GetGameObject().SetActive(false);


                    GameObjects.Park.Scene.Park.MainStaticGroup.HubFloor.GetGameObject().SetActive(false);
                    GameObjects.Park.Scene.Park.MainStaticGroup.Leaves.GetGameObject().SetActive(false);
                    GameObjects.Park.Scene.Park.MainStaticGroup.Root.GetGameObject().SetActive(false);
                    GameObjects.Park.Scene.Park.MainStaticGroup.Wood.GetGameObject().SetActive(false);

                    GameObjects.Park.Scene.Park.MainStaticGroup.Arenas.GymArena0.ArenaMetalRim.GetGameObject().SetActive(false);
                    GameObjects.Park.Scene.Park.MainStaticGroup.Arenas.GymArena0.RingClamp.GetGameObject().SetActive(false);
                    GameObjects.Park.Scene.Park.MainStaticGroup.Arenas.GymArena0.Rocks.GetGameObject().SetActive(false);

                    GameObjects.Park.Scene.Park.MainStaticGroup.Arenas.GymArena1.Rocks.GetGameObject().SetActive(false);
                    GameObjects.Park.Scene.Park.MainStaticGroup.Arenas.GymArena2.Rocks.GetGameObject().SetActive(false);
                    GameObjects.Park.Scene.Park.MainStaticGroup.Arenas.GymArena3.Rocks.GetGameObject().SetActive(false);
                    GameObjects.Park.Scene.Park.MainStaticGroup.Arenas.GymArena4.Rocks.GetGameObject().SetActive(false);

                    GameObjects.Park.Scene.Park.MainStaticGroup.Arenas.GymArena5.Rocks.GetGameObject().SetActive(false);
                    GameObjects.Park.Scene.Park.MainStaticGroup.Arenas.GymArena5.ArenaMetalRim.GetGameObject().SetActive(false);
                    GameObjects.Park.Scene.Park.MainStaticGroup.Arenas.GymArena5.Arena.GetGameObject().SetActive(false);



                    GameObjects.Park.Scene.Park.SubStaticGroup.Pedistals.GetGameObject().SetActive(false);
                    GameObjects.Park.Scene.Park.SubStaticGroup.Rocks.GetGameObject().SetActive(false);
                    ...
                    Renderer[] renderers2 = GameObjects.Park.Logic.HeinhouserProducts.GetGameObject().transform.GetComponentsInChildren<Renderer>();
                    ...
                    GameObjects.Park.Logic.ShiftstoneQuickswapper.LeftHandSlab.GetGameObject().transform.GetComponent<Renderer>().material = regionMaterial;
                    GameObjects.Park.Logic.ShiftstoneQuickswapper.RighthandSlab.GetGameObject().transform.GetComponent<Renderer>().material = regionMaterial;

                    GameObjects.Park.Logic.ParkToys.MatchCounter.Scoreboard.FirstPlayerNameUI.Text.GetGameObject().transform.GetComponent<TextMeshProUGUI>().color = new Color(0.5f, 0.5f, 0.5f, 1f);
                    GameObjects.Park.Logic.ParkToys.MatchCounter.Scoreboard.SecondPlayerNameUI.Text.GetGameObject().transform.GetComponent<TextMeshProUGUI>().color = new Color(0.5f, 0.5f, 0.5f, 1f);
                    GameObjects.Park.Logic.ParkToys.MatchCounter.Scoreboard.FirstPlayerScoreUI.Text.GetGameObject().transform.GetComponent<TextMeshProUGUI>().color = new Color(0.5f, 0.5f, 0.5f, 1f);
                    GameObjects.Park.Logic.ParkToys.MatchCounter.Scoreboard.SecondPlayerScoreUI.Text.GetGameObject().transform.GetComponent<TextMeshProUGUI>().color = new Color(0.5f, 0.5f, 0.5f, 1f);

                    GameObjects.Park.Logic.ParkToys.MatchCounter.Scoreboard.RestScoreUI.Text.GetGameObject().transform.GetComponent<TextMeshProUGUI>().color = new Color(0.5f, 0.5f, 0.5f, 1f);
                }
                else if (currentScene == "Map0" && GameObjects.Map0.Map0Production.Mountain.GetGameObject().active == true && modEnabled)
                {

                    GameObjects.Map0.LightingAndEffects.GetGameObject().SetActive(false);
                    GameObjects.Map0.Map0Production.Mountain.GetGameObject().SetActive(false);

                    GameObjects.Map0.Map0Production.MainStaticGroup.BackgroundPlane.GetGameObject().SetActive(false);
                    GameObjects.Map0.Map0Production.MainStaticGroup.BackgroundRocks.GetGameObject().SetActive(false);
                    GameObjects.Map0.Map0Production.MainStaticGroup.CombatFloor.GetGameObject().SetActive(false);
                    GameObjects.Map0.Map0Production.MainStaticGroup.Leaves.GetGameObject().SetActive(false);
                    GameObjects.Map0.Map0Production.MainStaticGroup.Root.GetGameObject().SetActive(false);

                    GameObjects.Map0.Map0Production.GetGameObject().transform.GetChild(0).GetChild(2).GetChild(1).gameObject.GetComponent<Renderer>().enabled = false;
                    ...
                    Renderer[] renderers = GameObjects.Map0.Map0Production.MainStaticGroup.GetGameObject().transform.GetComponentsInChildren<Renderer>();
                ...
                else if (currentScene == "Map1" && GameObjects.Map1.Map1Production.MainStaticGroup.DeathDirt.GetGameObject().active == true && modEnabled)
                {
                    GameObjects.Map1.LightingAndEffects.GetGameObject().SetActive(false);
                    ...
                    Renderer[] renderers = GameObjects.Map1.Map1Production.MainStaticGroup.GetGameObject().transform.GetComponentsInChildren<Renderer>();
        ...
        public void RenderClone(GameObject original, Transform poolParent, bool collidedWithMap = false, bool ignoreRendererEnabled = false, bool addToCloneList = true, bool playerCollisionClone = false)
        {
            ...
            GameObject localController = Managers.GetPlayerManager().localPlayer.Controller.gameObject;
